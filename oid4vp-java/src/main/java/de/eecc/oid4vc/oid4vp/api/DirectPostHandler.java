...
public interface DirectPostHandler<T extends PresentationRequest> {
     ...
     * @return direct_post response for the wallet; may be empty when no user-agent redirect is needed
     */
    VpTokenResponse.DirectPostResponse onVerified(T request, JsonNode vpToken);
}
